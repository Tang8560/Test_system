...
class get_instr(object): 
    ...
    def __init__(self):
        ...
        self.PS_ACU   = get_instr["Instrument"]["Power_Supply_ACU"]
        self.PS_BUC   = get_instr["Instrument"]["Power_Supply_BUC"]
        self.Spectrum = get_instr["Instrument"]["Spectrum_Analyzer"]
        self.RL_ACC   = get_instr["Instrument"]["Relay_ACC"]
        self.RL_LED   = get_instr["Instrument"]["Relay_LED"] 
        self.COM      = get_instr["Instrument"]["EMMC_COM"]        
